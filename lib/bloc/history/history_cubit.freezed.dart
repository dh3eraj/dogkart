...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(final List<DogImage> dogs) : _dogs = dogs;

  final List<DogImage> _dogs;
  @override
  List<DogImage> get dogs {
  ...
  @override
  String toString() {
    return 'HistoryState.loaded(dogs: $dogs)';
  }
...
abstract class _Loaded implements HistoryState {
  const factory _Loaded(final List<DogImage> dogs) = _$LoadedImpl;
